      ...
      <div aria-hidden className="pointer-events-none absolute inset-0 z-0">
        <div className="absolute inset-y-0 right-0 hidden w-[min(58vw,720px)] lg:block">
          <Image
            ...
            alt=""
            fill
            className="object-cover object-[62%_12%] saturate-[0.75] brightness-[0.55]"
            priority
            sizes="60vw"
          />
          <div className="absolute inset-0 bg-gradient-to-r from-brand-black from-5% via-brand-navy/90 via-40% to-transparent" />
          <div className="absolute inset-0 bg-gradient-to-t from-brand-black/80 via-transparent to-brand-navy/30" />
        </div>
        ...
        <div className="absolute inset-x-0 bottom-0 h-[min(42vh,320px)] lg:hidden">
          <Image
            ...
            alt=""
            fill
            className="object-cover object-[50%_8%] saturate-[0.75] brightness-[0.5]"
            priority
            sizes="100vw"
          />
          <div className="absolute inset-0 bg-gradient-to-t from-brand-black from-10% via-brand-navy/95 via-55% to-brand-navy/40" />
        </div>
      </div>
      ...
      <div className="relative z-[2] mx-auto max-w-6xl px-5 sm:px-6">
        <div className="py-16 sm:py-20 md:py-24 lg:py-28">
          <div className="max-w-2xl lg:max-w-xl xl:max-w-2xl">
            ...
            <Reveal delay={2}>
              <p className="mt-6 max-w-xl text-body-lg text-brand-chrome/90">
                {hero.bodyText}
              </p>
            </Reveal>
